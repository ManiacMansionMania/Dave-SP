...
/*! zeigt die Tür im geöffneten oder geschlossenen Zustand an, je nach Wert der übergebenen GlobalInt
		...
		\param nr_room der neue Raum, in den der Spieler wechselt
...
import bool SetDoorStrings(this Character*, String lookat, String islocked, String wrongitem);
//! setzt die Türenrückmeldungen für das Anschauen, für eine gesperrte Tür und für ein falsches Item zum Aufsperren
import bool SetDoorStrings(String lookat, String islocked, String wrongitem);
...
/*! lässt den Spieler an die angegebene Position laufen, den Gegenstand anschauen und bei gewählter eActPickup-Aktion danach ins Inventar aufnehmen
		...
		\param y vertiakle Position auf dem Bildschirm
		\param dir Die Richtung, in die der Spieler schaut, bevor die Tür geöffnet oder geschlossen wird
		\param lookat der Text, den der Spieler vor dem aufnehmen des Objektes sagt
		\param object das zu entfernende Objekt
		\param item der Inventargegenstand, der hinzugefügt werden soll
		\param gi die globale Variable, die das Ganze steuern soll
		\param sound die Soundnummer, die abgespielt werden soll
		\return 0 = unhandled; 1 = handled, but canceled; 2 = picked up */
...
#define TIMER_MAX 20
mytimerint timer[TIMER_MAX];

//import bool TimerSet(this mytimerint*);
import bool TimerSet(int timerid, int timeout);
import bool TimerExpired(int timerid);
import bool TimerCheck();
